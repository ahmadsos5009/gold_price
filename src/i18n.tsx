    ...
    resources: {
      en: {
        translations: {
          ...
          Welcome5:
            "We should know that gold price is linked to oil and dollar as following:",
          Welcome6:
      ...
      ara: {
        translations: {
          ...
          Welcome2:
            ".عبر التاريخ ، كان يُنظر إلى الذهب على أنه سلعة خاصة وقيمة",
          Welcome3:
            ".اليوم ، يمكن أن يكون امتلاك الذهب بمثابة تحوط ضد التضخم والانكماش على حد سواء ، فضلاً عن كونه أداة تنويع جيدة للمحفظة",
          Welcome4:
            "كمخزن عالمي للقيمة ، يمكن للذهب أيضًا توفير غطاء مالي خلال حالة عدم اليقين الجيوسياسي والاقتصاد الكلي",
          Welcome5:
            ":يجب أن نعلم أن سعر الذهب مرتبط بالنفط والدولار على النحو التالي",
          Welcome6:
            "كلما ارتفع سعر النفط ، ارتفع سعر الذهب ؛ العلاقة بينهما علاقة مباشرة",
          Welcome7:
            "كلما ارتفع سعر الدولار ، انخفض سعر الذهب. العلاقة بينهما معكوسة",
          currencysPage: "صفحة العملات",
          language: "لغة",
          metaTitle:
            "سعر الذهب في {{countryName}} - {{countryName}} سعر أوقية جرام كيلو الذهب في",
          metaDescription:
      ...
      deu: {
        translations: {
          ...
          Welcome2:
            "Im Laufe der Geschichte wurde Gold als besonderes und wertvolles Gut angesehen.",
          Welcome3:
            "Heute kann der Besitz von Gold sowohl als Absicherung gegen Inflation und Deflation als auch als guter Portfoliodiversifikator dienen.",
          Welcome4:
            "Als globaler Wertspeicher kann Gold auch bei geopolitischen und makroökonomischen Unsicherheiten finanzielle Deckung bieten.",
          Welcome5:
            "Wir sollten wissen, dass der Goldpreis wie folgt mit Öl und Dollar verbunden ist:",
          Welcome6:
            "Je höher der Ölpreis, desto höher der Goldpreis; Die Beziehung zwischen ihnen ist eine direkte Korrelation.",
          Welcome7:
            "Je höher der Preis des Dollars ist, desto niedriger ist der Goldpreis. Die Beziehung zwischen ihnen ist umgekehrt.",
      ...
      fra: {
        translations: {
          ...
          Welcome2:
            "Tout au long de l'histoire, l'or a été considéré comme une matière première spéciale et précieuse.",
          Welcome3:
            "Aujourd'hui, posséder de l'or peut servir de couverture contre l'inflation et la déflation, ainsi qu'un bon diversificateur de portefeuille.",
          Welcome4:
            "En tant que réserve de valeur mondiale, l'or peut également fournir une couverture financière en période d'incertitude géopolitique et macroéconomique.",
          Welcome5:
            "Il faut savoir que le prix de l'or est lié au pétrole et au dollar comme suit:",
          Welcome6:
            "Plus le prix du pétrole est élevé, de sorte que le prix de l'or; La relation entre eux est une corrélation directe.",
          Welcome7:
            "Plus le prix du dollar est élevé, plus le prix de l'or est bas. La relation entre eux est inverse.",
      ...
      zho: {
        translations: {
          ...
          Welcome3:
            "如今，拥有黄金既可以充当通货膨胀和通缩的避险工具，又可以作为良好的投资组合多元化产品。",
          Welcome4:
            "作为全球价值存储，黄金还可以在地缘政治和宏观经济不确定性期间提供财务保障。",
          Welcome5: "我们应该知道，黄金价格与石油和美元联系如下：",
          Welcome6:
            "石油的价格越高，黄金的价格就越高； 它们之间的关系是直接相关的。",
